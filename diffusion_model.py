...
class SelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # Bolt Optimization: batch shape operations before splitting to reduce PyTorch dispatcher overhead
        q, k, v = qkv.reshape(b, 3, c, h * w).transpose(-2, -1).unsqueeze(2).unbind(dim=1)
